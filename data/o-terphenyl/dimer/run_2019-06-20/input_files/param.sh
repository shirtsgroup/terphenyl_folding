...
name='dimer' # name of molecule. This name will carry through to output
nc=0  # net charge
res='DIM' # name of residue being made, NOTE: This must match the residue in the .pdb file or you will get errors
